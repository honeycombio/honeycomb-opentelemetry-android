...
These are the current versions of libraries we have tested for compatibility:
  ...
  | Dependency                                             | Version        |
  |--------------------------------------------------------|----------------|
  | `io.honeycomb.android:honeycomb-opentelemetry-android` | `0.0.17`       |
...
```kotlin
dependencies {
  implementation("io.honeycomb.android:honeycomb-opentelemetry-android:0.0.17")
}
```
...
```
dependencies {
  implementation("io.honeycomb.android:honeycomb-opentelemetry-android-compose:0.0.17")
}
```
